      ...
      $(this).bind({
        ...
        click : function(e){
          ...
          /** ONLY FOR THE DEMO, YOU CAN REMOVE THIS CODE **/
            $('.datasSent p').html('<strong>ID êîíòåéíåðà : </strong>'+idBox+'<br /><strong>Îöåíêà : </strong>'+rate+'<br /><strong>Äåéñòâèå :</strong> îöåíèâàíèå');
            $('.serverResponse p').html('<strong>Çàãðóçêà...</strong>');
